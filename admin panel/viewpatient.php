...
<body>
  <div class="navbar">
    ...
    <a href="viewbookings.php" class="nav-link active"> Patient Files</a>
  </div>   
  ...
  <div class="container">
      ...
      <div class="total-files"></div>
        ...
        <thead>
    <table class="database-table">    <h1>Patient Files</h1>
      <thead>
        <tr>
          <th>updateid</th>
          <th>name</th>
    ...
    if($results){
        while($row=$results->fetch_assoc()){
          ...
          <button class="btn btn-primary"><a href="deletee.php? deleteid ='.$updateid.'" class="text-light"> Delete</a>  </button>
